...
if __name__ == '__main__':
    ...
    while a:
        ...
        driver.find_element_by_id('reciever_name').send_keys('Вова Венгер')
        driver.find_element_by_id('reciever_phone').send_keys('380654583212')
        driver.find_element_by_id('reciever_email').send_keys('hrumsex@ukr.net')
        time.sleep(3)
        ...
        try:
            driver.find_element_by_xpath('//input[@data-title="Фамилия"]').send_keys('Вова')
            driver.find_element_by_xpath('//input[@data-title="Имя"]').send_keys('Венгер')
